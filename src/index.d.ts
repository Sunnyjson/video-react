...
declare module 'video-react' {
  ...
  class Player extends React.Component<PlayerPropsType> {
    ...
    getDefaultChildren(originalChildren: any): Array<React.Component>;

    getChildren(props: any): Array<React.Component>;
  ...
  namespace playerActions {
    ...
    function toggleFullscreen(player: any): { type: string;[key: string]: any };
  }
